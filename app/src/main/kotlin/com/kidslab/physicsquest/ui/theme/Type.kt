...
// Tipografía grande, redondeada y muy legible, pensada para niños de 8-12 años:
// pesos extra-fuertes en los títulos para que se sientan "de videojuego" y
// espaciado generoso entre líneas para que no se sientan apretados.
val PhysicsQuestTypography = Typography(
    displayLarge = TextStyle(fontWeight = FontWeight.ExtraBold, fontSize = 40.sp, lineHeight = 46.sp, letterSpacing = 0.2.sp),
